...
The lab will introduce you to building agents using Semantic Kernel. This will be a basic introduction to agents focussing on how to configure and invoke them. In the later labs, you will learn how to orchestrate multiple agents.

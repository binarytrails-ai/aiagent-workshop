...
This exercise is about creating a code-first agent in Azure AI Foundry Agent Service. You will create a customer service agent for Contoso, which will assist customers with inquiries about products, order status, returns, and general support.

You will also explore how to manage Agents from the Azure Foundry portal.

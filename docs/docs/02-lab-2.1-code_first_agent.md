...
This exercise is about creating a code-first agent in Azure AI Foundry Agent Service. 
...
3. **Test your Agent** - Click **Try in Playground** to test your agent in the playground. Try the following questions:
...
<!-- > **Tip:** If you encounter quota or rate limit issues, try again after a few seconds or check your Azure subscription quotas. -->
